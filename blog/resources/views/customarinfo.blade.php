...
@section('title','customar info')

@section('content')

	<h3 class="text-center">customar info</h3>
	<div class="col-md-7 ml-auto mr-auto">

		@if (session()->has('Message'))
			<div class="alert alert-success">{{ session()->get('Message')}}</div>
		@endif
		<form action="{{url('/savecustomarinfo')}}" method="POST">
			{{ csrf_field()}}
			...
			<button type="submit" class="btn btn-success text-center">customar info</button>
		</form>
	</div>
