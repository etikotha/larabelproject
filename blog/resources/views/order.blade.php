	...
	<div class="col-md-7 ml-auto mr-auto">
		...
		<form action="{{url('/saveorder')}}" method="POST">
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" name="book_name" id="book_name" placeholder="Book_Name" required>
			</div>
			<div class="form-group">
				<label for="author_name">Author Name :</label>
				<input type="text" class="form-control" name="author_name" id="author_name" placeholder="Auth_Name" required>
			</div>
			...
			<button type="submit" class="btn btn-success text-center">order Book</button>
		</form>
	</div>
